...
public class SwaggerConfig {
     ...
     * </ul>
     * Additionally, it configures the server URL for local development (localhost:7078).
     *
        ...
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                ...
                                .description("""
                                    API documentation for the Comment Service.
                                    This service provides operations for managing comments on posts, including:
                                    - Adding comments
                                    - Retrieving comments by post or ID
                                    - Updating and deleting comments
                                    - Verifying comment validity
                                    """
                                )
                                .version("1.0.0")
                                .contact(
                                        new Contact()
                                                .name("Comment Service Support Team")
