...
public class SwaggerConfig {
     ...
     * </ul>
     * Additionally, it configures the server URL for local development (localhost:7071).
     *
        ...
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                ...
                                .description("API documentation for the UserServiceImpl in the SocialNetwork application. " +
                                        "This API provides endpoints for user management, including registration, updates, " +
                                        "retrieval of user information, and more.")
                                .version("1.0.0")
                                .contact(new Contact()
                                        .name("SocialNetwork Support Team")
                                )
                );
    }
}
