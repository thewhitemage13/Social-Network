        ...
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                .title("Media API")
                                .description("""
                                    API documentation for the Media Service. 
                                    This service provides operations for managing media files:
                                    - Verifying the validity of media URLs
                                    - Uploading media files for users
                                ...
                                .contact(
                                        new Contact()
                                                .name("Media API Support Team")
                                                .email("support@mediaapi.com")
                                )
                );
    }
}
