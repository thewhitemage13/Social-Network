...
public class SwaggerConfig {
     ...
     * </ul>
     * Additionally, it configures the server URL for local development (localhost:7077).
     *
        ...
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                .title("Likes API")
                                .description("""
                                    API documentation for the Likes Service.
                                    This service provides operations for managing likes on posts and comments:
                                    - Retrieving like counts
                                    - Adding likes to posts and comments
                                    - Deleting likes
                                    - Checking like statistics
                                    """
                                )
                                .version("1.0.0")
                                .contact(
                                        new Contact()
                                                .name("Likes API Support Team")
