...
public class SwaggerConfig {
     ...
     * </ul>
     * Additionally, it configures the server URL for local development (localhost:7075).
     *
        ...
        return new OpenAPI()
                ...
                .info(
                        new Info()
                                ...
                                .description("""
                                        API documentation for the Notification Service.
                                        This service provides operations for managing notifications:
                                ...
                                .contact(
                                        new Contact()
                                                .name("Notification API Support Team")
