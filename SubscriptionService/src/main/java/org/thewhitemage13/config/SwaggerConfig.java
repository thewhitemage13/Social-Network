...
public class SwaggerConfig {
     ...
     * </ul>
     * Additionally, it configures the server URL for local development (localhost:7072).
     *
                ...
                .info(
                        new Info()
                                ...
                                .description("API documentation for the Subscription Service. " +
                                        "This API manages user subscriptions, followers, and following relationships.")
                                .version("1.0.0")
                                .contact(new Contact()
                                        .name("Support Team")
